...
namespace DictionaryDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string glGradAljaske = theStates["Alaska"].Capital;
            var theState = theStates["Alaska"];
            Console.WriteLine("The capital of Alaska is {0}, its population is {1} and it is {2} square miles big.", theState.Capital, theState.Population, theState.Size);
